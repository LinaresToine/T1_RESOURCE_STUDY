...
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_FR_CCIN2P3 --task-type=Skim --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_FR_CCIN2P3 --task-type=Production --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_FR_CCIN2P3 --task-type=Harvesting --pending-slots=1000 --running-slots=1000

#Settings for using T1_IT_CNAF
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --cms-name=T1_IT_CNAF --pnn=T1_IT_CNAF --ce-name=T1_IT_CNAF --pending-slots=20000 --running-slots=20000 --plugin=SimpleCondorPlugin
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --task-type=Processing --pending-slots=10000 --running-slots=10000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --task-type=Merge --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --task-type=Cleanup --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --task-type=LogCollect --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --task-type=Skim --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --task-type=Production --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_IT_CNAF --task-type=Harvesting --pending-slots=1000 --running-slots=1000
...
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_DE_KIT --task-type=Skim --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_DE_KIT --task-type=Production --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_DE_KIT --task-type=Harvesting --pending-slots=1000 --running-slots=1000


#Settings for using T1_UK_RAL
./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --cms-name=T1_UK_RAL --pnn=T1_UK_RAL --ce-name=T1_UK_RAL --pending-slots=20000 --running-slots=20000 --plugin=SimpleCondorPlugin
./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --task-type=Processing --pending-slots=10000 --running-slots=10000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --task-type=Merge --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --task-type=Cleanup --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --task-type=LogCollect --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --task-type=Skim --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --task-type=Production --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_UK_RAL --task-type=Harvesting --pending-slots=1000 --running-slots=1000


#Settings for using T1_ES_PIC
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --cms-name=T1_ES_PIC --pnn=T1_ES_PIC --ce-name=T1_ES_PIC --pending-slots=20000 --running-slots=20000 --plugin=SimpleCondorPlugin
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --task-type=Processing --pending-slots=10000 --running-slots=10000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --task-type=Merge --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --task-type=Cleanup --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --task-type=LogCollect --pending-slots=1000 --running-slots=1000
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --task-type=Skim --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --task-type=Production --pending-slots=1 --running-slots=1
#./config/tier0/manage execute-agent wmagent-resource-control --site-name=T1_ES_PIC --task-type=Harvesting --pending-slots=1000 --running-slots=1000
