...
help(){
    ...
    # ./wmagent-venv-deploy.sh -i test -t 2.2.1 -d /data/tmp/WMAgent.venv3/
    ...
    # ./wmagent-venv-deploy.sh -n -i test -t 2.2.1 -d /data/tmp/WMAgent.venv3/

    # Example: Deploy WMAgent from source repository, use tag 2.2.1,
    #          at destination /data/tmp/WMAgent.venv3/:
    # ./wmagent-venv-deploy.sh -s -t 2.2.1 -d /data/tmp/WMAgent.venv3/
    ...
    # ./wmagent-venv-deploy.sh -y -s -t 2.2.1 -d /data/tmp/WMAgent.venv3/
...
wmaInstall() {
    ...
    _addWMCoreVenvVar  WMA_BASE_DIR $WMA_ROOT_DIR/srv
    ...
    _addWMCoreVenvVar  WMA_HOSTADMIN_DIR $WMA_ADMIN_DIR/hostadmin
    _addWMCoreVenvVar  WMA_CURRENT_DIR $WMA_BASE_DIR/wmagent/current
    _addWMCoreVenvVar  WMA_INSTALL_DIR $WMA_CURRENT_DIR/install
    _addWMCoreVenvVar  WMA_CONFIG_DIR $WMA_CURRENT_DIR/config
    _addWMCoreVenvVar  WMA_MANAGE_DIR $WMA_CONFIG_DIR/wmagent
